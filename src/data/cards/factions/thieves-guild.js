export const thievesGuildAllied = [
  {
    ...
    choices: [
      { label: 'Buy the stolen supplies', deltas: { gold: -8, equipment: 12 }, major: false, reputation: -5, chains: null, rumorText: 'Someone has been acquiring suspiciously cheap equipment lately.' },
      { label: 'Pass — too close to the original theft', deltas: { equipment: -6, gold: 8 }, major: false, reputation: 5, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      { label: 'Take the roster and hide her people', deltas: { quests: 15, adventurers: -12 }, major: true, reputation: -5, chains: null, rumorText: 'Strangers have been seen coming and going from the guild hall after dark.' },
      { label: 'Too much heat — decline', deltas: { quests: -8, adventurers: 6 }, major: false, reputation: 5, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      { label: 'Lend your guild seal for the papers', deltas: { gold: 18, quests: -15 }, major: false, reputation: -10, chains: null, rumorText: 'A suspicious shipment cleared customs under a guild name.' },
      { label: 'Refuse — your seal isn\'t for sale', deltas: { quests: 8, gold: -5 }, major: false, reputation: 5, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      { label: 'Send a crew in tonight', deltas: { gold: 12, equipment: 10, adventurers: -8, quests: -10 }, major: true, reputation: -10, chains: null, rumorText: 'A guild crew was spotted near the warehouse district before last night\'s raid.' },
      { label: 'Stay out of it entirely', deltas: { gold: -8, quests: 6 }, major: false, reputation: -5, chains: null, rumorText: 'Word got back that the guild passed on a sure thing. The Guild isn\'t impressed.' },
    ],
  },
  {
    ...
    choices: [
      { label: 'Accept the training', deltas: { adventurers: 10, gold: -8 }, major: false, reputation: -5, chains: null, rumorText: 'Some guild members have been seen at unusual locations during off hours.' },
      { label: 'Train your people the legitimate way', deltas: { gold: -10, adventurers: 8 }, major: false, reputation: 5, chains: null, rumorText: null },
    ],
  },
]
...
export const thievesGuildOpposed = [
  {
    ...
    choices: [
      { label: 'Hire extra security', deltas: { gold: -12, adventurers: 10 }, major: false, reputation: 5, chains: null, rumorText: 'The guild has been beefing up its street presence.' },
      { label: 'Let it slide — don\'t escalate', deltas: { equipment: -8, gold: 6 }, major: false, reputation: -5, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      { label: 'Testify against the guild', deltas: { quests: 15, adventurers: -12 }, major: true, reputation: 10, chains: null, rumorText: 'A guild master testified before the city magistrate. The streets are tense.' },
      { label: 'Stay out of the magistrate\'s war', deltas: { quests: -8, gold: 6 }, major: false, reputation: -5, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      { label: 'Protect her and take the information', deltas: { adventurers: 8, gold: -10, quests: 5 }, major: true, reputation: 5, chains: null, rumorText: 'Someone is sheltering a guild defector. The guild is not pleased.' },
      { label: 'Send her away — it\'s not your fight', deltas: { adventurers: -6, gold: 8 }, major: false, reputation: -5, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      { label: 'Take the contract', deltas: { gold: 15, adventurers: -12 }, major: true, reputation: 10, chains: null, rumorText: 'A guild company was working alongside city guards in the docks.' },
      { label: 'Decline — too dangerous for your people', deltas: { quests: -8, gold: 6 }, major: false, reputation: -5, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      { label: 'Help him reclaim the route', deltas: { gold: 10, equipment: 8, adventurers: -15 }, major: false, reputation: 10, chains: null, rumorText: 'A guild company took on a job that put them directly against guild interests.' },
      { label: 'Stay out of trade disputes', deltas: { gold: 8, quests: -5 }, major: false, reputation: 0, chains: null, rumorText: null },
    ],
  },
]
