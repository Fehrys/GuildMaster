export const templeAllied = [
  {
    ...
    choices: [
      ...
      { label: 'Recommend another group instead', deltas: { gold: 5 }, major: false, reputation: -5, chains: null, rumorText: null },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      { label: 'Accept the salves with the conditions', deltas: { equipment: 12, quests: -5 }, major: false, reputation: 10, chains: null, rumorText: 'The guild master has been speaking warmly of the temple in public.' },
...
export const templeOpposed = [
  {
    ...
    choices: [
      ...
      { label: 'Let it pass — clients will decide for themselves', deltas: { quests: -8 }, major: false, reputation: 5, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      { label: 'Pay and apologize to gain admission', deltas: { gold: -15, adventurers: 7 }, major: false, reputation: -10, chains: null, rumorText: 'The guild master was seen humbling themselves at the temple gate.' },
      { label: 'Use street healers — slower but independent', deltas: { gold: -8, adventurers: 3 }, major: false, reputation: 5, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      { label: 'Pay him to find a different corner', deltas: { gold: -12, quests: 8 }, major: false, reputation: -5, chains: null, rumorText: 'The guild reportedly paid to silence a street preacher.' },
      { label: 'Wait it out — he\'ll move on eventually', deltas: { quests: -5, adventurers: 3 }, major: false, reputation: 0, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      ...
      { label: 'Find a compromise through temple intermediaries', deltas: { gold: -15, adventurers: 5 }, major: false, reputation: 5, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      ...
      { label: 'Leave temple politics to the city', deltas: { gold: 5 }, major: false, reputation: 5, chains: null, rumorText: null },
    ],
  },
]
