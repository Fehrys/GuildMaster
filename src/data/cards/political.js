export const politicalCards = [
  {
    ...
    choices: [
      { label: 'Pay the fee', deltas: { gold: -12, quests: 10 }, major: false, reputation: 5, chains: null, rumorText: null },
      { label: 'Ignore it', deltas: { quests: -18, gold: 13 }, major: false, reputation: -5, chains: 'chain-tax-ignored', rumorText: null },
    ],
  },
  {
    id: 'std-minor-lord',
    ...
    choices: [
      { label: 'Accept the contract', deltas: { gold: 20, adventurers: -15, quests: -5 }, major: true, reputation: 5, chains: null, rumorText: 'Lord Hestan\'s gold came with strings. You\'ll feel the absence of your people soon.' },
      { label: 'Decline', deltas: { quests: -8, adventurers: 5 }, major: false, reputation: -5, chains: null, rumorText: null },
    ],
  },
  {
    id: 'std-donation',
    ...
    choices: [
      { label: 'Donate generously', deltas: { gold: -12, quests: 10 }, major: false, reputation: 10, chains: null, rumorText: null },
      { label: 'Decline politely', deltas: { quests: -8, adventurers: 6 }, major: false, reputation: -5, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      ...
      { label: 'Skip it', deltas: { quests: -8, adventurers: 6 }, major: false, reputation: 0, chains: null, rumorText: null },
    ],
  },
  {
    id: 'std-noble-party',
    ...
    choices: [
      ...
      { label: 'Send apologies', deltas: { quests: -8, adventurers: 6 }, major: false, reputation: -5, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      { label: 'Send aid', deltas: { gold: -10, adventurers: -5, quests: 12 }, major: false, reputation: 15, chains: null, rumorText: null },
      { label: 'Not your concern', deltas: { quests: -8, adventurers: 6 }, major: false, reputation: -5, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      ...
      { label: 'Refuse', deltas: { quests: -8, gold: 6 }, major: false, reputation: -5, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      { label: 'Full cooperation', deltas: { adventurers: -8, quests: -5, gold: 10 }, major: false, reputation: 5, chains: null, rumorText: null },
      { label: 'Grease his palm', deltas: { gold: -12, quests: 10 }, major: false, reputation: 0, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      ...
      { label: 'Back the contracts candidate', deltas: { quests: 12, gold: -8 }, major: false, reputation: -5, chains: null, rumorText: 'Word spreads that your guild chose city gold over guild principle.', factions: { 'city-guard': 'allied', 'merchants': 'opposed' } },
    ],
  },
  {
    id: 'std-noble-feud',
    ...
    choices: [
      ...
      { label: 'Offer to mediate', deltas: { adventurers: -5, quests: 8 }, major: false, reputation: 10, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      { label: 'Host them lavishly', deltas: { gold: -20, quests: 18 }, major: false, reputation: 10, chains: null, rumorText: null },
      { label: 'Offer modest hospitality', deltas: { gold: -8, quests: 6 }, major: false, reputation: 5, chains: null, rumorText: null },
    ],
  },
  {
    id: 'std-tax-reform',
    ...
    choices: [
      ...
      { label: 'Lobby against it', deltas: { gold: -10, equipment: 8 }, major: false, reputation: 5, chains: null, rumorText: null, factions: { 'city-guard': 'allied' } },
    ],
  },
  {
    id: 'std-public-works',
    ...
    choices: [
      { label: 'Fund a portion', deltas: { gold: -18, quests: 15 }, major: false, reputation: 10, chains: null, rumorText: null },
      { label: 'Contribute a small sum', deltas: { gold: -6, quests: 8 }, major: false, reputation: 5, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      { label: 'Participate fully', deltas: { gold: -22, quests: 18 }, major: false, reputation: 15, chains: null, rumorText: null },
      { label: 'Skip the ceremony', deltas: { quests: -10, gold: 8 }, major: false, reputation: -10, chains: null, rumorText: 'Your absence at the royal parade did not go unnoticed at court.' },
    ],
  },
  {
    ...
    choices: [
      { label: 'Apologise and pay restitution', deltas: { gold: -15, quests: 12 }, major: false, reputation: 5, chains: null, rumorText: null },
      { label: 'Dismiss the complaint', deltas: { quests: -12, gold: 10 }, major: false, reputation: -10, chains: null, rumorText: 'The consul made certain everyone heard how your guild handles its messes.' },
    ],
  },
  {
    ...
    choices: [
      { label: 'Back the established temple', deltas: { gold: -10, quests: 12 }, major: false, reputation: 5, chains: null, rumorText: null, factions: { 'temple': 'allied', 'thieves-guild': 'opposed' } },
  ...
  },
  {
    ...
    choices: [
      ...
      { label: 'Wait it out', deltas: { quests: -8, adventurers: 6 }, major: false, reputation: -5, chains: null, rumorText: null },
    ],
  },
  {
    id: 'std-royal-decree',
    ...
    choices: [
      { label: 'Open the capital office', deltas: { gold: -25, adventurers: -8, quests: 15, equipment: 15 }, major: true, reputation: 10, chains: null, rumorText: null },
      { label: 'Contest the decree legally', deltas: { gold: -10, quests: -8, adventurers: 15 }, major: false, reputation: 5, chains: 'chain-decree-contested', rumorText: 'Your guild\'s legal challenge to the crown drew attention — for better and worse.' },
    ],
  },
  {
    ...
    choices: [
      { label: 'Accept the alliance', deltas: { gold: -10, quests: 12 }, major: false, reputation: 8, chains: null, rumorText: null, factions: { 'noble-south': 'allied' } },
      { label: 'Decline gracefully', deltas: { quests: -8, adventurers: 6 }, major: false, reputation: -5, chains: null, rumorText: null },
    ],
  },
  {
    id: 'std-public-trial',
    ...
    choices: [
      { label: 'Testify fully and honestly', deltas: { quests: -10, gold: -5, equipment: 12 }, major: false, reputation: 10, chains: null, rumorText: null },
      { label: 'Decline to testify', deltas: { quests: 8, gold: -5 }, major: false, reputation: -10, chains: null, rumorText: 'Rumours swirl that your guild has something to hide from the trial.' },
    ],
  },
  {
    id: 'std-council-seat',
    ...
    choices: [
      { label: 'Accept the council seat', deltas: { gold: -20, adventurers: -10, quests: 18, equipment: 10 }, major: true, reputation: 15, chains: null, rumorText: null },
      { label: 'Decline and recommend an ally', deltas: { quests: 5, gold: -5 }, major: false, reputation: 5, chains: null, rumorText: null, factions: { 'merchants': 'allied' } },
    ],
  },
  {
    ...
    choices: [
      { label: 'Pull the strings', deltas: { quests: 12, gold: -8 }, major: false, reputation: -8, chains: null, rumorText: 'Whispers suggest your guild has ties to the criminal underworld.', factions: { 'thieves-guild': 'allied', 'city-guard': 'opposed' } },
      { label: 'Refuse firmly', deltas: { quests: -8, adventurers: 6 }, major: false, reputation: 5, chains: null, rumorText: null, factions: { 'thieves-guild': 'opposed' } },
    ],
  },
  {
    ...
    choices: [
      { label: 'Report accurately', deltas: { gold: -15, quests: 12 }, major: false, reputation: 8, chains: null, rumorText: null },
      { label: 'Underreport slightly', deltas: { gold: -8, adventurers: 6 }, major: false, reputation: -5, chains: 'chain-census-fraud', rumorText: null },
    ],
  },
  {
    ...
    choices: [
      ...
      { label: 'Drive a hard bargain', deltas: { gold: 15, quests: -12 }, major: false, reputation: -5, chains: null, rumorText: 'The rival town delegation left with a bitter taste — and long memories.' },
    ],
  },
]
