export const guildLifeCards = [
  {
    ...
    choices: [
      { label: 'Take her in', deltas: { adventurers: 8, gold: -5 }, major: false, reputation: 5, chains: 'chain-merc-healed', rumorText: null },
      { label: 'Turn her away', deltas: { adventurers: -6, equipment: 8 }, major: false, reputation: -5, chains: null, rumorText: 'Word spreads. The wounded remember those who turned them away.' },
    ],
  },
  {
    ...
    choices: [
      { label: 'Take a chance', deltas: { adventurers: 8, gold: -5 }, major: false, reputation: 0, chains: null, rumorText: null },
      { label: 'Send them away', deltas: { adventurers: -6, equipment: 8 }, major: false, reputation: -3, chains: null, rumorText: 'Word gets out that your guild turned away an eager young recruit.' },
    ],
  },
  {
    id: 'std-old-map',
    ...
    choices: [
      ...
      { label: 'Pass', deltas: { quests: -6, gold: 8 }, major: false, reputation: 0, chains: null, rumorText: null },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      { label: 'Decline the offer', deltas: { adventurers: -8, equipment: 6 }, major: false, reputation: 0, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      ...
      { label: 'Decline the risk', deltas: { quests: -8, adventurers: 5 }, major: false, reputation: -5, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      { label: 'Agree', deltas: { equipment: -10, quests: 8 }, major: false, reputation: 0, chains: 'chain-alchemist-done', rumorText: null },
      { label: 'Decline', deltas: { quests: -6, gold: 8 }, major: false, reputation: -3, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      { label: 'Take the contract', deltas: { gold: 8, adventurers: -5, quests: -5 }, major: false, reputation: 5, chains: null, rumorText: null },
      { label: 'Too low-paying', deltas: { quests: -8, equipment: 6 }, major: false, reputation: -3, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      ...
      { label: 'Not yet', deltas: { quests: -6, gold: 8 }, major: false, reputation: 0, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      { label: 'Generous sendoff', deltas: { gold: -10, adventurers: -5, quests: 12 }, major: false, reputation: 5, chains: null, rumorText: 'Old Garrus was seen at the docks, laughing with a tankard in his hand. He earned it.' },
  ...
  },
  {
    ...
    choices: [
      { label: 'Rest them properly', deltas: { adventurers: -8, equipment: 6 }, major: false, reputation: 0, chains: null, rumorText: null },
      { label: 'Back on their feet', deltas: { adventurers: -10, quests: 8 }, major: false, reputation: 0, chains: null, rumorText: 'Word gets out: your guild pushes its people too hard.' },
    ],
  },
  {
    ...
    choices: [
      ...
      { label: 'Patch the worst', deltas: { gold: -8, equipment: 6 }, major: false, reputation: 0, chains: null, rumorText: null },
    ],
  },
  {
    id: 'std-brek-drills',
    ...
    choices: [
      ...
      { label: 'Too much downtime', deltas: { adventurers: -8, equipment: 6 }, major: false, reputation: -5, chains: null, rumorText: 'Word is the guild has been skipping training. Standards are slipping.' },
    ],
  },
  {
    ...
    choices: [
      { label: 'Reprimand the veterans', deltas: { adventurers: -6, quests: 8 }, major: false, reputation: 5, chains: null, rumorText: 'The guild\'s new recruits look noticeably less rattled these days.' },
      { label: 'Let tradition stand', deltas: { adventurers: -8, gold: 6 }, major: false, reputation: -5, chains: null, rumorText: 'Rumor has it your guild\'s hazing rituals are driving away promising recruits.' },
    ],
  },
  {
    id: 'std-feast-day',
    ...
    choices: [
      { label: 'Throw the feast', deltas: { gold: -15, adventurers: 12 }, major: false, reputation: 5, chains: null, rumorText: 'The smell of roasted boar drifted across the whole district last night.' },
      { label: 'Keep it simple', deltas: { gold: -8, equipment: 6 }, major: false, reputation: 0, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      ...
      { label: 'Politely decline', deltas: { equipment: -8, gold: 6 }, major: false, reputation: -3, chains: null, rumorText: null },
    ],
  },
  {
    id: 'std-night-watch',
    ...
    choices: [
      { label: 'Set up the rotation', deltas: { adventurers: -8, equipment: 6 }, major: false, reputation: 0, chains: null, rumorText: null },
      { label: 'Keep current schedule', deltas: { equipment: -8, gold: 6 }, major: false, reputation: 0, chains: null, rumorText: 'Someone broke into the guild storeroom last night.' },
    ],
  },
  {
    ...
    choices: [
      ...
      { label: 'Sit it out', deltas: { quests: -8, adventurers: 5 }, major: false, reputation: -5, chains: null, rumorText: null },
    ],
  },
  {
    id: 'std-jolen-tip',
    ...
    choices: [
      { label: 'Pay him to spread word', deltas: { gold: -10, quests: 8 }, major: false, reputation: 5, chains: null, rumorText: 'Word around the taverns is that the other guild has been cutting corners.' },
      { label: 'Win on merit alone', deltas: { quests: -8, adventurers: 6 }, major: false, reputation: 0, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      { label: 'Send the research team', deltas: { adventurers: -5, quests: 10 }, major: false, reputation: 0, chains: null, rumorText: null },
      { label: 'No time for books', deltas: { quests: -6, gold: 8 }, major: false, reputation: 0, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      { label: 'Full repair now', deltas: { gold: -18, equipment: 15 }, major: false, reputation: 5, chains: null, rumorText: 'The guild hall looks proper again — Oren did solid work.' },
      { label: 'Patch it for now', deltas: { gold: -8, equipment: 6 }, major: false, reputation: 0, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      { label: 'Launch the program', deltas: { adventurers: 15, quests: -12 }, major: false, reputation: 0, chains: null, rumorText: null },
      { label: 'Sink-or-swim approach', deltas: { adventurers: -8, gold: 6 }, major: false, reputation: 0, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      { label: 'Give the raise', deltas: { gold: -12, adventurers: 10 }, major: false, reputation: 5, chains: null, rumorText: 'The guild staff seem satisfied — for now.' },
      { label: 'Let them go', deltas: { adventurers: -8, equipment: 6 }, major: false, reputation: -5, chains: null, rumorText: 'Your former steward was heard venting in the tavern. Loudly.' },
    ],
  },
  {
    id: 'std-supply-run',
    ...
    choices: [
      ...
      { label: 'Local scrounge', deltas: { gold: -8, equipment: 6 }, major: false, reputation: 0, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      ...
      { label: 'Wing it', deltas: { quests: -8, adventurers: 6 }, major: false, reputation: -8, chains: null, rumorText: 'The inspection notes were... not favorable.' },
    ],
  },
  {
    ...
    choices: [
      ...
      { label: 'Standard issue is fine', deltas: { equipment: -8, gold: 6 }, major: false, reputation: 0, chains: null, rumorText: null },
    ],
  },
  {
    ...
    choices: [
      { label: 'Full paid recovery', deltas: { gold: -8, adventurers: -5, quests: 8 }, major: false, reputation: 5, chains: null, rumorText: null },
      { label: 'Light duty only', deltas: { adventurers: -10, equipment: 8 }, major: false, reputation: -5, chains: null, rumorText: 'Renn is limping through jobs. People have noticed.' },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      { label: 'Give them a breather', deltas: { quests: -8, gold: -5, adventurers: 10 }, major: false, reputation: 0, chains: null, rumorText: null },
      { label: 'Work through it', deltas: { adventurers: -8, equipment: 6 }, major: false, reputation: 0, chains: null, rumorText: 'Three members handed in their resignation this week. No explanation.' },
    ],
  },
  {
    ...
    choices: [
      { label: 'Pay the renewal fee', deltas: { gold: -10, quests: 8 }, major: false, reputation: 5, chains: null, rumorText: null },
      { label: 'Offer a quiet bribe', deltas: { gold: -8, adventurers: 6 }, major: false, reputation: -5, chains: null, rumorText: 'A city clerk was seen pocketing something outside your hall. People talk.' },
    ],
  },
]
