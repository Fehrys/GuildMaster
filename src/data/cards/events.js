export const worldEventCards = [
  {
    ...
    choices: [
      ...
      { label: 'Monitor from a distance', deltas: { quests: 8, gold: -3, adventurers: -3, equipment: -5 }, major: true, rumorText: null, resultText: "Scouts return with maps and careful notes while other guilds send in their boldest — and lose them. The choice to hold back cost something, but preserved enough to matter later.", chains: null },
    ]
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      { label: 'Run the betting pools', deltas: { gold: 8, quests: -5, adventurers: 5, equipment: -10 }, major: true, rumorText: null, resultText: "Numbers move through the back room faster than the crowd moves through the arena gates. When the dust settles and the champions are crowned, your ledger is the quiet winner of the day.", chains: null },
    ]
  },
  {
    id: 'event-siege',
    ...
    choices: [
      { label: 'Join the city defense', deltas: { adventurers: -15, equipment: -15, gold: 15, quests: 12 }, major: true, rumorText: null, resultText: "The walls hold. They hold because your people were on them. When the gates finally open again, the Commander pays what was promised — and the city carves your guild's part in this into something more lasting than gratitude.", chains: null },
      { label: 'Evacuate non-essentials', deltas: { gold: -10, adventurers: -8, equipment: 10, quests: 5 }, major: true, rumorText: null, resultText: "Wagons move through the south gate before dawn, carrying records, valuables, and people the guild cannot afford to lose. It costs more than expected. The siege ends without your fighters on the wall — a fact no one says aloud, but none forget.", chains: null },
    ]
  },
  {
    id: 'event-trade-fair',
    ...
    choices: [
      ...
      { label: 'Buy selectively', deltas: { gold: 8, equipment: 5, adventurers: -3, quests: -12 }, major: true, rumorText: null, resultText: "Careful choices at the fair mean the guild walks away with exactly what it needed and nothing it didn't. The restraint goes unnoticed by the crowd, which is precisely the point.", chains: null },
    ]
  },
  {
    id: 'event-famine',
  ...
  },
  {
    ...
    choices: [
      ...
      { label: 'Bar the gates', deltas: { adventurers: -5, equipment: -5, quests: 5, gold: 3 }, major: true, rumorText: null, resultText: "Shutters close across the district and the guild waits out the rumble and stink from behind barred doors. The migration passes. The opportunity passes with it. Some things you can only watch go by.", chains: null },
    ]
  },
  {
    ...
    choices: [
      ...
      { label: 'Give a modest reception', deltas: { gold: -8, adventurers: -3, quests: 8, equipment: 2 }, major: true, rumorText: null, resultText: "Measured hospitality, respectfully delivered. The royal party seems unsurprised — great guilds rarely overreach at these things. What the guild loses in spectacle it recovers in composure.", chains: null },
    ]
  },
  {
    ...
    choices: [
      ...
      { label: 'Negotiate contracts', deltas: { quests: -8, gold: 8, adventurers: 3, equipment: -5 }, major: true, rumorText: null, resultText: "Politics is left to the guilds that can afford the bruises. Ink dries on agreements that will pay out long after the conclave's speeches are forgotten, and the guild walks out with more than it arrived with.", chains: null },
    ]
  },
  {
    id: 'event-earthquake',
  ...
  },
  {
    ...
    choices: [
      ...
      { label: 'Stay out of it', deltas: { quests: -5, adventurers: 5, gold: 3, equipment: -6 }, major: true, rumorText: null, resultText: "Doors stay closed and opinions stay unvoiced. The witch-hunt burns through the city like a fire that doesn't care where the wind came from. When the smoke clears, the guild is still standing — untouched, uncommitted, and quietly grateful for both.", chains: null },
    ]
  },
];
